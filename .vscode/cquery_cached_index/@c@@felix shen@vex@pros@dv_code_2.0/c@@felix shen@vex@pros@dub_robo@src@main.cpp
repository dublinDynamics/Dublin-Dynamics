...
//debugging variables
bool printBaseVals = true;
bool printLiftVals = false;
bool printRollerVals = false;
bool printTrayVals = false;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (printRollerVals) {
			...
			pros::lcd::print(4, "currLeftRollerVal: %f", currLeftRollerVal);
			pros::lcd::print(5, "leftRollerSetVal: %f", leftRollerSetVal);
			pros::lcd::print(6, "leftRollerErr: %f", leftRollerErr);
			pros::lcd::print(7, "left_roller_mtr: %f", (leftRollerErr * leftRollerKp));
		}
		//Manual roller code
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (printTrayVals) {
			...
			pros::lcd::print(4, "currTrayVal: %f", currTrayVal);
			pros::lcd::print(5, "traySetVal: %f", traySetVal);
			pros::lcd::print(6, "trayErr: %f", trayErr);
			pros::lcd::print(7, "tray_mtr: %f", (trayErr * trayKp));
		}
		//Manual lift code
