...
static const double autoTrayKp = 0.6;
static const double autoTraySetVal = -900;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    //left base true speed
	 	left_mtr = returnTrueSpeed (master.get_analog(ANALOG_LEFT_Y)) + returnTrueSpeed (master.get_analog(ANALOG_RIGHT_X));
		left_mtr2 = returnTrueSpeed (master.get_analog(ANALOG_LEFT_Y)) + returnTrueSpeed (master.get_analog(ANALOG_RIGHT_X));
	 	//right base true speed
	  right_mtr = returnTrueSpeed (master.get_analog(ANALOG_LEFT_Y)) - returnTrueSpeed (master.get_analog(ANALOG_RIGHT_X));
		right_mtr2 = returnTrueSpeed (master.get_analog(ANALOG_LEFT_Y)) - returnTrueSpeed (master.get_analog(ANALOG_RIGHT_X));
